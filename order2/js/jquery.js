(function () {
  ...
  var names = {
    men: ['Ермек', 'Рустам', 'Руслан', 'Азамат', 'Батырхан', 'Бауыржан', 'Аманжол', 'Арман', 'Ерболат', 'Жандос',
      'Максат', 'Серик', 'Дамир', 'Данияр', 'Сабит', 'Арнур', 'Аскар', 'Ержан', 'Карим', 'Мирас', 'Султан', 'Шади', 'Уали', 'Алексей', 'Константин', 'Юрий', 'Касымхан']
  };

  // Список товаров
  var goods = ['Мужские Часы + Портмоне'];
  ...
  var cities = ['Актау', 'Нур-Султан', 'Костанай', 'Актобе', 'Атырау', 'Кокшетау', 'Алматы', 'Караганда', 'Семей',
    'Шымкент', 'Тараз', 'Павлодар', 'Петропавловск', 'Усть-Каменогорск', 'Темиртау', 'Экибастуз', 'Туркестан',
    'Рудный', 'Уральск', 'Кызылорда', 'Жанаозен', 'Аксу', 'Акколь', 'Сарыагаш', 'Жетысай', 'Абай',
    'Курчатов', 'Шу', 'Жезказган', 'Аркалык', 'Зайсан', 'Уштобе', 'Державинск', 'Степняк', 'Есик', 'Жаркент'
  ];
  var showsCounter = 0;
  var userGeo;
